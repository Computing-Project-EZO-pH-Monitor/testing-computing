...
TX(SDA)pin on the pH meter connects to GPIO pin 2 on the Raspberry Pi. GPIO stands for general-purpose input/output pin.
...
```
#!/usr/bin/env python
import io # this is used to create file streams
import fctnl # this is used to access the I2C parameters like addresses
import time # used for sleep delay and timestamps
import string #  helps parse the strings
```
